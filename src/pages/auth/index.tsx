...
import { LoginSchema, RegisterSchema, loginSchema, registerSchema } from "@/lib/utils/apis/auth";
                ...
                <form onSubmit={formRegist.handleSubmit(handleRegist)}>
                  <div className="flex flex-col gap-4 md:gap-8 p-10">
                    <CustomFormField control={formRegist.control} name="nama">
                      {(field) => <Input {...field} placeholder="Full Name" className="placeholder:text-greenPrimary" disabled={form.formState.isSubmitting} aria-disabled={formRegist.formState.isSubmitting} />}
                    </CustomFormField>
                    <CustomFormField control={formRegist.control} name="email">
                      {(field) => <Input {...field} placeholder="Email" className="placeholder:text-greenPrimary" disabled={form.formState.isSubmitting} aria-disabled={formRegist.formState.isSubmitting} />}
                    </CustomFormField>
                    <CustomFormField control={formRegist.control} name="username">
                      {(field) => <Input {...field} placeholder="Username" className="placeholder:text-greenPrimary" disabled={form.formState.isSubmitting} aria-disabled={formRegist.formState.isSubmitting} />}
                    </CustomFormField>
                    <CustomFormField control={formRegist.control} name="password">
                      {(field) => <Input {...field} placeholder="Password" className="placeholder:text-greenPrimary" disabled={form.formState.isSubmitting} aria-disabled={formRegist.formState.isSubmitting} />}
                    </CustomFormField>
                  </div>
                ...
                <form onSubmit={form.handleSubmit(handleLogin)}>
                  <div className="flex flex-col gap-4 md:gap-8 p-10">
                    <CustomFormField control={form.control} name="username">
                      {(field) => <Input {...field} placeholder="Username" type="text" className="placeholder:text-greenPrimary" disabled={form.formState.isSubmitting} aria-disabled={form.formState.isSubmitting} />}
                    </CustomFormField>
                    <CustomFormField control={form.control} name="password">
                      {(field) => <Input {...field} placeholder="Password" type="password" className="placeholder:text-greenPrimary" disabled={form.formState.isSubmitting} aria-disabled={form.formState.isSubmitting} />}
                    </CustomFormField>
                  </div>
